...
from app.views import index, ask, question, settings, log_in, signup, hot, tag, search, log_out, like, answer_like
urlpatterns = [
    ...
    path('like/answer', answer_like, name = 'answer_like_url')
]
